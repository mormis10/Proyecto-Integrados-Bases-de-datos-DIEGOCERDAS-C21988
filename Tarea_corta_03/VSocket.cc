...
**/
int VSocket::EstablishConnection(const char *host, const char *service, bool IPV6) {
  int st = -1;
...
int VSocket::Bind( int port ) {
  ...
  //En este caso utilizamos la sockaddr_in 6 pq es de seis bits
  ...
  // para este caso tenemos que escuchar todas las IPV6 disponibles 
...
size_t VSocket::sendTo( const void * buffer, size_t size, void * addr ) {
   int st = sendto(this->idSocket, buffer, size, 0, (const struct sockaddr *)addr, sizeof(struct sockaddr_in6));
